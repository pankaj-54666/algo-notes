...
\begin{solution}[Brute Force | $O(n^2)$]
    ...
    \includegraphics[width=\textwidth]{solution/LC209_S1.jpg}
\end{solution}

\begin{solution}[Prefix Sum + BS | $O(n*log n)$]

    \includegraphics[width=\textwidth]{solution/LC209_S2.jpg}
    
\end{solution}

\begin{solution}[Sliding Window | $O(n)$]
    \includegraphics[width=\textwidth]{solution/LC209_S3.jpg}
